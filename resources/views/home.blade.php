...
@section('content')
  ...
  <!-- Banner Section  -->
    ...
    <div class="bg-light row pt-4 px-lg-5 position-relative">
            ...
            <div class="col-lg-4 col-sm-12 col-md-6 home-service-col bg-light">
                <div class="p-4 bg-white">
                    <div class="p-3 text-center home-service-border">
                        ...
                        <img style="height: 243px;" class="w-100" src="{{ asset(''.$v->image) }}" alt="">
                        @else 
                        <img class="w-100" src="{{ asset('assets/images/trial4.png') }}" alt="">
                        @endif
        ...
        <div class="btn-box z-ind text-center">
            <a class="home-service-button rounded-pill bg-dark fw-bold" href="page-about.html"><span>SEE
                    MORE</span></a>
        </div>
    </div>
