...
@section('title')
<title>CoconCoach | Category</title>
@stop
                   ...
                   <tbody class="fw-semibold text-gray-600">
                        @if(count($data) >0 )
                            ...
                            <tr class="odd">
                                ...
                                <td data-order="2023-06-24T20:43:00+05:30">	<img src="{{asset(''.$item->image)}}" alt="" width="80px" height="80px"></td>
